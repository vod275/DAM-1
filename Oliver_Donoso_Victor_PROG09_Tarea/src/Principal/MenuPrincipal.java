...
public class MenuPrincipal {
        ...
        while (true) {
            ...
            switch (opcion) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    guardarDatos(curso, listaProfesores, listaEstudiantes);
                    break;
                case 10:
                    cargarDatos();
                    break;
    ...
    private static void mostrarMenu() {
        ...
        System.out.println("9. Guardar datos en disco");
        System.out.println("10. Cargar datos de disco");
        System.out.println("11. Salir");
        System.out.print("Seleccione una opción: ");
    }

    /**
     * Método para crear un nuevo curso solicitando al usuario las fechas de inicio y fin.
    ...
    /**
     * Método para crear un nuevo profesor solicitando al usuario información como DNI/NIE,
     * identificador, nombre, fecha de alta, correo electrónico y asignatura que impartirá.
     * @param scanner El scanner para leer la entrada del usuario.
     */
    ...
    /**
     * Método para crear un nuevo estudiante solicitando al usuario información como DNI/NIE,
     * identificador, nombre, correo electrónico, fecha de matriculación y notas para cada asignatura.
     * @param scanner El scanner para leer la entrada del usuario.
     */
    ...
    /**
    * Método para actualizar la nota de un estudiante en una asignatura específica.
    * Se solicita al usuario que ingrese el ID del estudiante y el código de la asignatura
    * para la cual se actualizará la nota. Luego se muestra la nota actual y se solicita
    * la nueva nota, la cual debe estar en el rango de 0 a 10. La nota se actualiza en el
    * arreglo de notas del curso.
    * @param scanner El scanner para leer la entrada del usuario.
    */
    ...
    /**
     * Método para generar un informe detallado sobre una asignatura impartida por un profesor.
     * Se solicita al usuario que ingrese el ID del profesor que imparte la asignatura. Luego se
     * obtienen las estadísticas de la asignatura, incluyendo el número de alumnos aprobados y suspendidos,
     * el porcentaje de aprobados y suspendidos, la nota media, la nota mínima y la nota máxima.
     * @param scanner El scanner para leer la entrada del usuario.
     */
    ...
    /**
     * Método para generar un informe detallado sobre un estudiante.
     * Se solicita al usuario que ingrese el ID del estudiante y se muestran los datos identificativos del alumno,
     * así como la relación de notas de todas las asignaturas. Se calculan estadísticas como el número de aprobados,
     * el número de suspendidos, la nota media y el porcentaje de asignaturas aprobadas.
     * @param scanner El scanner para leer la entrada del usuario.
     */
    ...
    /**
    * Método para generar un informe general del curso, mostrando los nombres de las asignaturas,
    * las notas de cada estudiante en esas asignaturas y la nota media del curso.
    * Se muestra un encabezado con el nombre del curso, seguido de una tabla con los identificadores,
    * nombres y notas de cada estudiante en cada asignatura, junto con la nota media de cada asignatura
    * y la nota media del curso.
    * Si no se puede obtener la información del curso, se muestra un mensaje de error y se sale del método.
    */
   ...
   /**
   * Método para obtener una fecha válida ingresada por el usuario.
   * Solicita al usuario que ingrese una fecha en formato "dd-MM-yyyy" hasta que se ingrese una fecha válida.
   * @param scanner Scanner para leer la entrada del usuario.
   * @return LocalDate objeto que representa la fecha válida ingresada por el usuario.
   */
     ...
     * Solicita al usuario el código del estudiante que desea eliminar y elimina al estudiante del curso si está registrado.
     * @param scanner Scanner para leer la entrada del usuario.
     */
    private static void eliminarEstudiante(Scanner scanner) {
        ...
        // Verificar si no hay ningún curso creado actualmente
        if (curso == null) {
            System.out.println("No hay ningún curso creado actualmente.");
            return;
        }

        // Verificar si no hay ningún estudiante en el curso
        if (listaEstudiantes == null || listaEstudiantes.isEmpty()) {
            System.out.println("No hay ningún estudiante en el curso.");
            return;
        }
    ...
    /**
     * Método para guardar los datos del curso, profesores y estudiantes en un archivo binario.
     * Los datos se guardan en un archivo llamado "Curso.dat".
     * @param curso Objeto Curso que se desea guardar.
     * @param profesores Lista de objetos Profesor que se desea guardar.
     * @param estudiantes Lista de objetos Estudiante que se desea guardar.
     */
    public static void guardarDatos(Curso curso, List<Profesor> profesores, List<Estudiante> estudiantes) {
        try (FileOutputStream fos = new FileOutputStream("Curso.dat");
    ...
    /**
    * Método para cargar los datos del archivo binario "datos.dat" y asignarlos a las variables estáticas del menú principal.
    * Se cargan el curso, la lista de profesores y la lista de estudiantes.
    */
    public static void cargarDatos() {
        try (FileInputStream fis = new FileInputStream("datos.dat");
            ...
            // Cargar el curso
            Curso cursoCargado = (Curso) ois.readObject();
            MenuPrincipal.curso = cursoCargado;

            // Cargar los profesores
            List<Profesor> profesoresCargados = new ArrayList<>();
            try {
                while (true) {
            ...
            MenuPrincipal.listaProfesores = profesoresCargados;
            ...
            MenuPrincipal.listaEstudiantes = estudiantesCargados;
